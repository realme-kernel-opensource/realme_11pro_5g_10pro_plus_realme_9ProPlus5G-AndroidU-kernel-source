...
/*Xuewen.Yang@MULTIMEDIA.MACHINE,2021/06/25, Add for haptic tfa*/
...
#ifdef CONFIG_SND_SOC_TFA_HAPTIC
/*Xuewen.Yang@MULTIMEDIA.MACHINE,2021/06/25, Add for tfa haptic*/
	tfa_haptic_i2s_be_dailink(mt6877_mt6359_dai_links, ARRAY_SIZE(mt6877_mt6359_dai_links));
#endif /* CONFIG_SND_SOC_TFA_HAPTIC */

//#ifdef OPLUS_ARCH_EXTENDS
	/*Xuewen.Yang@MULTIMEDIA.MACHINE,2021/06/25, Add for oplus extend audio*/
