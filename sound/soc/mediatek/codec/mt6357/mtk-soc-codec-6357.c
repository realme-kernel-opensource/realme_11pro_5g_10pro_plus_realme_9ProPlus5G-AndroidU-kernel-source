...
/*Haiping.Bai@MULTIMEDIA.AUDIODRIVER.CODEC,2021/11/25,add PA manager*/
...
/*Haiping.Bai@MULTIMEDIA.AUDIODRIVER.CODEC,2021/12/1,add audio bring up*/
...
#ifdef OPLUS_ARCH_EXTENDS
/*Haiping.Bai@MULTIMEDIA.AUDIODRIVER.CODEC,2022/02/15,add audio bring up*/
		if (GetDLStatus() == false || (pa_stereo == true)) {
#endif
			/* Pull-down HPL/R to AVSS28_AUD */
			hp_pull_down(true);
...
#endif
#ifdef OPLUS_ARCH_EXTENDS
/*Haiping.Bai@MULTIMEDIA.AUDIODRIVER.CODEC,2022/2/11,add audio bring up*/
		if ((GetDLStatus() == false)  || (pa_stereo == true))
#endif
			TurnOnDacPower(
...
// Haiping.Bai@MULTIMEDIA.AUDIODRIVER.AUDIODRIVER, 2022/1/28, change micbias0 to 2P7V
