...
/* Haiping.bai@MULTIMEDIA.AUDIODRIVER.HEADSETDET.2022/1/6, add for hp delay detection */
	struct delayed_work hp_detect_work;
#endif
#ifdef CONFIG_HSKEY_BLOCK
	/* Haiping.Bai@PSW.MM.AudioDriver.HeadsetDet, 2021/06/21,
...
#ifdef CONFIG_HSKEY_BLOCK
	/* Haiping.Bai@PSW.MM.AudioDriver.HeadsetDet, 2022/1/6,
	* add for hs key blocking for 1s after insterting */
...
#ifdef OPLUS_ARCH_EXTENDS
/* Haiping.bai@MULTIMEDIA.AUDIODRIVER.HEADSETDET.2022/2/9, modify for hp VTH 2v*/
	accdet_write(RG_AUDACCDETMICBIAS0PULLLOW_ADDR,
