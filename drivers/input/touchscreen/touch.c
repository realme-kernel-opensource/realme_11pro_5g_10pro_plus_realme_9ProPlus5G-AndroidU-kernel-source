...
bool __init tp_judge_ic_match(char *tp_ic_name)
{
	...
	case 20131:
		...
		return false;
	/*zengshangwen@BSP.TP.Function,2022/4/01,add tp path for Blade.*/
	case 22603:
	case 22604:
	case 22609:
	case 0x2260A:
	...
	case 23253:
		...
		return false;
	/*peiyuexiang@BSP.TP.Function,2023/03/13,add tp path for Lijing.*/
	case 22083:
	case 22084:
	case 22291:
	case 22292:
...
int tp_util_get_vendor(struct hw_resource *hw_res, struct panel_info *panel_data)
{
	...
	/*Qicai.gu@BSP.TP.Function, 2020/12/16, add tp path for yasuo.*/
...
/*BSP.TP.Function, add tp path for Moss.*/
	...
	/*Xuhang.Li@BSP.TP.Function, 2021/06/25, add tp path for mozi.*/
	...
	/*Baihang.Wang@BSP.TP.Function, 2021/3/1, add tp path for garen.*/
