...
struct mtk_panel_params {
	...
	//zhubing@PSW.MM.DisplayDriver, 2021/03/10, add for esd two para compare
	...
	/* liwei.a@PSW.MM.Display.LCD.Machine 2020/11/10, add for panel vendor info*/
	unsigned char vendor[32];
	unsigned char manufacture[32];
    /*Yaqiang.Shi@RM.Display.Driver,add for esd recovery*/
    bool esd_check_multi;
    /* lianghao1@PSW.MM.Display.LCD.Machine 2021/9/18, add for panel color status*/
	...
	*/
	...
	/* Shusheng.Bei@MM.Display.LCD.Feature, add for mipi switch */
