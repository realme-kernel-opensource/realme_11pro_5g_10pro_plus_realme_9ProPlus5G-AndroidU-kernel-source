...
#ifdef OPLUS_BUG_STABILITY
/* JianTao.Liu@PSW.MultiMedia.Display.LCD.Feature, 2021/11/04, Add shutdown sequence flag for lcd  */
int is_shutdown_flow = 0;
/* Zhijun.Ye@MM.Display.LCD, 2022/03/31, add for fixing recovery issue */
...
/* chenjun@MULTIMEDIA.Display.LCD, 2021/09/24, tmp remove doze pq bypass */
