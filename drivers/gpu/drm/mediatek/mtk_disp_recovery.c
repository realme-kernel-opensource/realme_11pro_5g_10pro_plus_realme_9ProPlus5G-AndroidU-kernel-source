...
//#ifdef OPLUS_FEATURE_ESD
/*Yaqiang.shi@RM.Display.Drvier,2021/12/30,add for esd recovery,add for aod state avoid esd recovey*/
bool aod_flag = false;
...
int _mtk_esd_check_read(struct drm_crtc *crtc)
{
	...
	//#ifndef OPLUS_FEATURE_ESD
	/*liwei.a@PSW.MM.Display.LCD.Stability, 2021/06/29, add for esd recovery */
