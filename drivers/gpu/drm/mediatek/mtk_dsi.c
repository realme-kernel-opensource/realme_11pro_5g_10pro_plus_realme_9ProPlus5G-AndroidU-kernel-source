...
/* Shusheng.Bei@DISPLAY.MM.DRV.AOD, 2022/6/10, add for forbid enter ulps aod state */
...
#ifdef OPLUS_BUG_STABILITY
/* liwei.a@PSW.MM.Display.LCD.Stability, 2021/02/08, add for esd detection*/
...
static int mtk_dsi_poweron(struct mtk_dsi *dsi)
{
	...
	#ifdef OPLUS_BUG_STABILITY
	/* Zhijun.Ye@MM.Display.LCD, 2022/04/07, add for power on sequence */
...
#ifdef OPLUS_BUG_STABILITY
/* Zhijun.Ye@PSW.MM.Display.LCD, 2022/03/03, add for oled ic timming */
...
#ifdef OPLUS_BUG_STABILITY
/* Zhijun.Ye@MM.Display.LCD, 2022/04/20, add for lcd */
...
#ifdef OPLUS_BUG_STABILITY
/* JianBin.Zhang@PSW.MM.Display.LCD.Stability, 2021/03/18, add for send cmd befor read panel serial number */
			  ...
			  enum mtk_ddp_io_cmd cmd, void *params)
{
	...
	/*liwei.a@PSW.MM.Display.LCD.Feature, 2020/12/30, add for seed*/
	case LCM_SEED:
	{
		struct mtk_dsi *dsi =
			container_of(comp, struct mtk_dsi, ddp_comp);
