...
#ifdef OPLUS_BUG_STABILITY
/* Xiaoqi.Hao@PSW.MM.Display.LCD.Machine 2021/12/07, Add set_gamma feature for mt6765_S */
...
/* Xiaoqi.Hao@PSW.MM.Display.LCD.Machine 2021/12/17,modify backlight level to aal for mt6765_S */
