...
//Luoruihan@NETWORK.DATA.4731263,2022/12/27,add for add for MTK patch udp disable GRO
...
static int is_skb_gro(struct sk_buff *skb)
{
	...
	//Luoruihan@NETWORK.DATA.4731263,2022/12/27,modified for MTK patch udp disable GRO
	/*
