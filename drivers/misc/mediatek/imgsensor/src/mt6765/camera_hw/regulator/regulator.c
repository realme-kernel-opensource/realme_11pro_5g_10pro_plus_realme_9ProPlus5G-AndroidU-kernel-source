...
#ifdef OPLUS_FEATURE_CAMERA_COMMON
//yunbo@CAMERA.DRV.[3404653],20220407,
...
#ifdef OPLUS_FEATURE_CAMERA_COMMON
//yunbo@CAMERA.DRV.[3404653],20220328,Add for QTECH_S5K3L6
...
static enum IMGSENSOR_RETURN regulator_init(void *pinstance)
{
	...
	if (pdevice->of_node == NULL) {
      ...
      #ifdef OPLUS_FEATURE_CAMERA_COMMON
      //yunbo@CAMERA.DRV.[3404653],20220407,Add for Camera Sensor Regulator Restricting voltage
      of_node_record = pdevice->of_node;
      #endif /*OPLUS_FEATURE_CAMERA_COMMON*/

    #ifdef OPLUS_FEATURE_CAMERA_COMMON
    /*Shicheng@Cam.Drv add for optimizing zhaoyun camera init time 20220217*/
...
/*Suna.Li@Cam.Drv add for optimizing parkera camera init time 20210329*/
...
static enum IMGSENSOR_RETURN regulator_release(void *pinstance)
{
    ...
    #ifdef OPLUS_FEATURE_CAMERA_COMMON
    /*Shicheng@Cam.Drv add for optimizing parkera camera init time 20210329*/
    if (is_project(21331) || is_project(21332) || is_project(21333)
        || is_project(21334) || is_project(21335) || is_project(21336)
        || is_project(21337) || is_project(21338) || is_project(21339)) {
