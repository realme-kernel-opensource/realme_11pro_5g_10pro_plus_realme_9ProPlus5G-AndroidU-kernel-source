...
static kal_uint32 open(void)
{
	...
	imgsensor.ihdr_en = 0;
	//miaozhongshu@Cam.Drv, 2022/05/05, add for zhaoyun pattern mode enable open camera not init
			...
			MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	//miaozhongshu@Cam.Drv, 2022/05/05, add for zhaoyun set pattern mode after init
