...
// Yongzhi.Zhang@PSW.MM.AudioDriver.HeadsetDet, 2020/04/12, add for hs key blocking for 1s after insterting
...
#endif /* CONFIG_HSKEY_BLOCK */
// Yongzhi.Zhang@PSW.MM.AudioDriver.HeadsetDet.1223267, 2019/03/27, add for not sending hook key release when plugging out
...
#ifdef OPLUS_BUG_COMPATIBILITY
// Yongzhi.Zhang@PSW.MM.AudioDriver.HeadsetDet, 2019/03/12, modified for waiting for 6s before disabling micbias
